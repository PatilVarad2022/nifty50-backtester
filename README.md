...
✅ **Audit Reproduced**: `python audit_script.py` — All metrics independently verified  
🔒 **SHA256 Hash**: `0E93BA3DF3EC263D765775A9B5F78E00AE25765B4BA4144A419078F2B1195083E` (outputs/metrics.json)  
📄 **Checksum File**: `outputs/metrics.sha256` (generated by `./run_full_report.sh`)
...
# OR: bash run_full_report.sh  # Windows Git Bash
